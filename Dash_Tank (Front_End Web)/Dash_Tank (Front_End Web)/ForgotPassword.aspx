<%@ Page Title="" Language="C#" MasterPageFile="~/Dash-Tank.Master" AutoEventWireup="true" CodeBehind="ForgotPassword.aspx.cs" Inherits="Dash_Tank__Front_End_Web_.ForgotPassword" %>
                        ...
                        <div id="edit_profile">
                            <div>
                                <form action="my_account.html" runat="server">
                                    ...
                                    <asp:Button id="forgpass" runat="server" Text="Send" class="btn btn-primary btn-block" OnClick="Send_Click" />
                        <div class="py-2">
