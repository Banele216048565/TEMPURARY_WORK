<%@ Page Title="" Language="C#" MasterPageFile="~/Dash-Tank.Master" AutoEventWireup="true" CodeBehind="NewRegister.aspx.cs" Inherits="Dash_Tank__Front_End_Web_.NewRegister" %>
            ...
            <div class="py-5 osahan-profile row">
                ...
                <div class="col-md-8 mb-3">
                    <div class="rounded shadow-sm p-4 bg-white">
                        <h5 class="mb-4">Welcome To Dash-Tank</h5>
                        <div id="edit_profile">
                            <div>
                                <form action="my_account.html" runat="server">
                                    <div class="form-group">
                                        <label for="exampleInputName1">Name</label>
                                        <input type="text" placeholder="Enter Name" class="form-control" id="exampleInputName1d" >
                                    </div>
                                    <div class="form-group">
                                        <label for="exampleInputName1">Surname</label>
                                        <input type="text" placeholder="Enter Surname" class="form-control" id="exampleInputName1" >
                                    </div>
                                    <div class="form-group">
                                        <label for="exampleInputNumber1">Mobile Number</label>
                                        <input type="number" placeholder="Enter Number" class="form-control" id="exampleInputNumber1" >
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="email" placeholder="Enter Password" class="form-control" id="exampleInputEmail1" >
                                    </div>

                                    <asp:Button id="Register" runat="server" Text="Register" class="btn btn-primary btn-block" OnClick="Register_Click" />
                        <div class="py-2">

                            <a href="Login.aspx" class="btn btn-primary btn-block"> Login </a>
