                                    ...
                                    <div class="row">
                                       ...
                                       <div>
                                          <div class="p-3 rounded bg-white shadow-sm w-100">
                                             ...
                                             <p class="small text-muted m-0"> 19 ParkTown Johannesburg</p>
                                             <p class="small text-muted m-0">Gauteng , South Africa</p>
                                          </div>
                                          <a href="#"  data-toggle="modal" data-target="#exampleModal" class="btn btn-block btn-light border-top">Edit</a>
                                       </div>
                ...
                <div class="col-md-4">
                    <div class="osahan-cart-item rounded rounded shadow-sm overflow-hidden bg-white sticky_sidebar">
                        ...
                        <div class="bg-white p-3 clearfix border-bottom">
                            ...
                            <p class="mb-1">Restaurant Charges <span class="float-right text-dark">R62.8</span></p>
                            ...
                            <p class="mb-1 text-success">Total Discount<span class="float-right text-success">R1884</span></p>
                            <hr>
