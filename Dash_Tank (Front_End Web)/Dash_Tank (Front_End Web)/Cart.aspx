                                ...
                                <div class="p-3 rounded shadow-sm bg-white">
                                    <div class="d-flex border-bottom pb-3">
                                        <div class="text-muted mr-3">
                                            <img alt="#" src="img/Shell-Logo.png" class="img-fluid order_img rounded">
                                        </div>
                                        <div>
                                            <p class="mb-0 font-weight-bold"><a href="restaurant.html" class="text-dark">Avis</a></p>
                                    ...
                                    <div class="d-flex pt-3">
                                        <div class="small">
                                            <p class="text- font-weight-bold mb-0">Shell 93 Unleaded </p>
                                            <p class="text- font-weight-bold mb-0">Shell 95 Unleaded</p>
                                        </div>
                            ...
                            <div class="pb-3">
                                <div class="p-3 rounded shadow-sm bg-white">
                                    <div class="d-flex border-bottom pb-3">
                                        ...
                                        <div>
                                            <p class="mb-0 font-weight-bold"><a href="restaurant.html" class="text-dark">Avis</a></p>
                                            <p class="mb-0">Pretoria, South Africa</p>
                                            <p>ORDER #321DERS</p>
                                            <p class="mb-0 small"><a href="status_complete.html">View Details</a></p>
                                        </div>
                                        <div class="ml-auto">
                            ...
                            <div class="pb-3">
                                <div class="p-3 rounded shadow-sm bg-white">
                                    <div class="d-flex border-bottom pb-3">
                                        ...
                                        <div>
                                            <p class="mb-0 font-weight-bold"><a href="restaurant.html" class="text-dark">Avis</a></p>
                                            <p class="mb-0">Avis, Johannesburg</p>
                                            <p>ORDER #321DERS</p>
                                    ...
                                    <div class="d-flex pt-3">
                                        ...
                                        <div class="text-muted m-0 ml-auto mr-3 small">Total Payment<br>
                                            <span class="text-dark font-weight-bold">R1200</span>
                                        </div>
                                        <div class="text-right">
