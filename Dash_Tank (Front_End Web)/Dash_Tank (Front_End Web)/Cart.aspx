<%@ Page Title="" Language="C#" MasterPageFile="~/Dash-Tank.Master" AutoEventWireup="true" CodeBehind="Cart.aspx.cs" Inherits="Dash_Tank__Front_End_Web_.Cart" %>
                                    ...
                                    <div class="row">
                                       ...
                                       <div>
                                          <div class="p-3 bg-white rounded shadow-sm w-100">
                                             ...
                                             <p class="small text-muted m-0">345 James Street</p>
                                             <p class="small text-muted m-0">Johannesburg, 2091</p>
                                          </div>
                    ...
                    <div class="osahan-cart-item rounded rounded shadow-sm overflow-hidden bg-white sticky_sidebar">
                        <div class="d-flex border-bottom osahan-cart-item-profile bg-white p-3">
                            ...
                            <div class="d-flex flex-column">
                                ...
                                <p class="mb-0 small text-muted"><i class="feather-map-pin"></i> 2036 2ND AVE, Pretoria, 6215</p>
                            </div>
                        </div>
                        <div class="bg-white border-bottom py-2">
                            ...
                            <div class="gold-members d-flex align-items-center justify-content-between px-3 py-2 border-bottom">
                                <div class="media align-items-center">
                                    <div class="mr-2 text-danger">&middot;</div>
                                    <div class="media-body">
                                        <p class="m-0">95 Unleaded
                                        </p>
                                    </div>
                                </div>
                                <div class="d-flex align-items-center">
                                    <span class="count-number float-right"><button type="button" class="btn-sm left dec btn btn-outline-secondary"> <i class="feather-minus"></i> </button><input class="count-number-input" type="text" readonly="" value="2"><button type="button" class="btn-sm right inc btn btn-outline-secondary"> <i class="feather-plus"></i> </button></span>
                                    <p class="text-gray mb-0 float-right ml-2 text-muted small">R628</p>
                                </div>
                            </div>
                            <div class="gold-members d-flex align-items-center justify-content-between px-3 py-2 border-bottom">
                                <div class="media align-items-center">
                        ...
                        <div class="bg-white p-3 clearfix border-bottom">
                            <p class="mb-1">Item Total <span class="float-right text-dark">R3140</span></p>
                            <p class="mb-1">DashTank Charges <span class="float-right text-dark">R62.8</span></p>
                            <p class="mb-1">Delivery Fee<span class="text-info ml-1"><i class="feather-info"></i></span><span class="float-right text-dark">R10</span></p>
                        ...
                        <div class="p-3">
                            <a class="btn btn-success btn-block btn-lg" href="successful.html">PAY R1329<i class="feather-arrow-right"></i></a>
                        </div>
                    </div>
                </div>
            </div>
