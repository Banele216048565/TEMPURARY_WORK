<%@ Page Title="" Language="C#" MasterPageFile="~/Dash-Tank.Master" AutoEventWireup="true" CodeBehind="StatusComplete.aspx.cs" Inherits="Dash_Tank__Front_End_Web_.StatusComplete" %>
                                    ...
                                    <div class="osahan-status">
                                        ...
                                        <div class="p-3 border-bottom">
                                            <div class="d-flex">
                                                ...
                                                <span class="ml-auto"><a href="Tracking.aspx" class="btn btn-primary">Track on map</a></span>
                                            </div>
                                        ...
                                        <div class="p-3 border-bottom bg-white">
                                            ...
                                            <p class="m-0 small">554 West 142nd Street, Johannesburg, Gauteng, South Africa</p>
                                        </div>
                                        <div class="p-3 border-bottom">
                                            <p class="font-weight-bold small mb-1">Courier</p>
                                            <img alt="#" src="img/logo_web.png" class="img-fluid sc-osahan-logo mr-2"> <span class="small text-primary font-weight-bold">DashTank
                                    </span>
                                        </div>
                                        <!-- total price -->
                                        <!-- Destination -->
                                        <div class="p-3 border-bottom bg-white">
                                            <div class="d-flex align-items-center mb-2">
                                                ...
                                                <h6 class="font-weight-bold ml-auto mb-1">R8.52</h6>
                                            </div>
